...
var imageViewer_component_1 = require("./imageViewer.component");
...
var ImageViewerModule = /** @class */ (function () {
    ...
    ImageViewerModule = __decorate([
        core_1.NgModule({
            ...
            providers: [imageViewer_service_1.ImageViewerService],
            declarations: [imageViewer_component_1.ImageViewerComponent],
            exports: [imageViewer_component_1.ImageViewerComponent]
        })
    ], ImageViewerModule);
